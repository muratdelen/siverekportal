...
//        configuration::getPageHeaderBefore("fullCalendar 2.2.5");
    ...
    <!--        <section class="content-header">
              ...
              <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Ana Menü</a></li>
                <li><a href="#">Erişim Hataları</a></li>
                <li class="active">Yasak</li>
              </ol>
            </section>-->
            ...
            <section class="content">
                <div class="error-page">
                    ...
                    <div class="error-content">
                        <h3><i class="fa fa-warning text-yellow"></i> Sayfaya Erişme Yetkiniz Bulunmamaktadır.</h3>
                        <p>
                            Lütfen Yetki Talebinde Bulununuz. <br>
                            <u><a href="<?php echo BASE_URL; ?>">burayı</a></u> tıklatarak anasayfaya geçebilirsiniz.
                        </p>
