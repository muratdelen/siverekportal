...
<script>
    ...
    function logincontrol() {
        ...
        $.ajax({
            ...
            error: function (data) {
                is_logined = false;
                adminLTE_alert(true, "OTURUM SÜRENİZ DOLDU LÜTFEN TEKRARDAN OTURUM AÇINIZ", '<iframe id="frame-login-control" src="http://portal.Siverek.edu.tr/controlLogin.php" style="overflow:hidden;height:80vh;width:100%" height="100%" width="100"></iframe>', "danger");
            }
        });
        return is_logined;
    }
...
//        console.log("%c Bu Uygulama ", "color:orange;  font-size: 30pt");
        console.log("%c Bilgisayar Yüksek Mühendisi ", "color:orange;  font-size: 30pt");
        ...
        console.log("%c Tarafından Yapıldı.", "color:orange; font-size: 30pt");
    });
</script>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                    ...
                    <a href="#" role="button" onclick="$('#user-image-upload').click();
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="/siverekportal?logout" class="btn bg-purple btn-flat"><?= __("Çıkış") ?></a>
                            </div>
                        </li>
                </ul>
                </li>
                ...
                echo '<li class="user-menu" onclick="location.href=' . "'" . '/siverekportal/login' . "'" . '" >
                    <a href="' . BASE_URL . '?openam" class="dropdown-toggle" data-toggle="dropdown" style="color:#fff !important; ">
                    <i class="fa fa-sign-in"></i>
                              <span class="hidden-xs">' . __("Sistem Girişi") . '</span>
                    </a>
                </li>';
            }
            ?>
