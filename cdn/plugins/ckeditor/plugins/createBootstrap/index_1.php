...
<html lang="en"><head>
    ...
    <link href="include/app.css" rel="stylesheet">
        <script type="text/javascript" src="include/app.js"></script>
    <!--<script src="include/ca-pub-6033984710828720.js"></script>-->
    <!--<script src="include/analytics.js" async="">-->
        <!--</script>-->
        <!--<script type="text/javascript">var NREUMQ = NREUMQ || []; NREUMQ.push(["mark", "firstbyte", new Date().getTime()]);</script>-->

        <!--<link rel="canonical" href="include/build.htm">-->



    </head>

    <body style="min-height: 700px;" class="edit builder">
    <div class="navbar navbar-inverse navbar-fixed-top navbar-layoutit">
        ...
        <div class="collapse navbar-collapse"> 
            <!--      <ul class="nav pull-right">
                    <li>
                      <div class="btn-group btn-donate pull-right">
                        ...
                        <button name="submit" alt="PayPal - The safer, easier way to pay online!" class="btn btn-xs btn-success"><i class="glyphicon-gift glyphicon"></i> Donate!</button>
                        <img alt="Donate to LayoutIt!" src="include/pixel.gif" border="0" height="1" width="1">
                        </form>
                      </div>
                      <div class="btn-group">
                                                                    
                        <a class="btn btn-xs btn-info" href="http://www.layoutit.com/en/register">Register</a> 
                        <a class="btn btn-xs btn-info" href="http://www.layoutit.com/en/login">Login</a>
                                </div>
                      <div class="btn-group" data-toggle="buttons-radio">				    
                        <button href="/hire/index" role="button" data-toggle="modal" data-target="#layoutitModal" class="btn btn-xs btn-danger btn-hire-header-builder">
                          <i class="glyphicon-envelope glyphicon"></i> Hire Us            </button>
                      </div>
                      <div class="btn-group" data-toggle="buttons-radio">				    
                        <button href="/feedbacks/indexV3" role="button" data-toggle="modal" data-target="#layoutitModal" id="feedback" class="btn btn-xs btn-primary">
                          <i class="glyphicon-comment glyphicon"></i> Feedback            </button>
                      </div>
                    </li>
                  </ul>-->
            <ul class="nav" id="menu-layoutit">
                <li>
                    <div class="btn-group" data-toggle="buttons-radio">
                        <button id="edit" class="active btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit "></i> Edit</button>
                    ...
                    <div class="btn-group">							
                      ...
                      <!--<button class="btn btn-xs btn-primary" id="button-share-modal" href="/share/indexV3" data-toggle="modal" data-target="#layoutitModal"><i class="glyphicon-share glyphicon"></i> Share</button>-->
                        ...
                        <button class="btn btn-xs btn-info" id="continue-download-non-logged" ><i class="glyphicon-trash glyphicon"></i> Result</button>
                    </div> 
                </li>
            </ul>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <ul class="nav nav-list accordion-group">
                    <li class="nav-header">
                        <div class="pull-right popover-info"><i class="glyphicon glyphicon-question-sign"></i> 
                            <div class="popover fade right"><div class="arrow"></div> 
                                ...
                                <div class="popover-content">To change the column configuration you 
                                    can edit the different values in the input (they should add 12). If you 
                                    need more info please visit <a target="_blank" href="http://getbootstrap.com/css/#grid">Bootstrap grid system.</a></div></div> 
                        </div> 
                    ...
                    <li class="rows" id="estRows">
                        ...
                        <div class="lyrow ui-draggable">
                            <a href="#close" class="remove label label-danger"><i class="glyphicon-remove glyphicon"></i> remove</a>
                            <span class="drag label label-default  ui-draggable-handle"><i class="glyphicon glyphicon-move"></i> drag</span>
                            <div class="preview"><input value="6 6" placeholder="Enter your own" class="form-control" type="text"></div>
                            <div class="view">
                                <div class="row">
                        ...
                        <div class="lyrow ui-draggable">
                            <a href="#close" class="remove label label-danger"><i class="glyphicon-remove glyphicon"></i> remove</a>
                            <span class="drag label label-default  ui-draggable-handle"><i class="glyphicon glyphicon-move"></i> drag</span>
                            <div class="preview"><input value="8 4" placeholder="Enter your own" class="form-control" type="text"></div>
                            <div class="view">
                                <div class="row">
                        ...
                        <div class="lyrow ui-draggable">
                            <a href="#close" class="remove label label-danger"><i class="glyphicon-remove glyphicon"></i> remove</a>
                            <span class="drag label label-default  ui-draggable-handle"><i class="glyphicon glyphicon-move"></i> drag</span>
                            <div class="preview"><input value="4 4 4" placeholder="Enter your own" class="form-control" type="text"></div>
                            <div class="view">
                                <div class="row">
                                    <div class="col-md-4 column"></div>
                                    <div class="col-md-4 column"></div>
                        ...
                        <div class="lyrow ui-draggable">
                            ...
                            <div class="preview"><input placeholder="Enter your own" class="form-control" type="text"></div>
                            <div class="view">
                                <div class="row">
                                </div>
                            </div>
                ...
                <ul class="nav nav-list accordion-group">
                    <li class="nav-header"><i class="glyphicon glyphicon-plus"></i> Base CSS
                        <div class="pull-right popover-info"><i class="glyphicon glyphicon-question-sign "></i> 
                            <div class="popover fade right"><div class="arrow"></div> 
                                <h3 class="popover-title">Help</h3> 
                                <div class="popover-content">Drag &amp; Drop the elements inside the 
                                    columns where you want to insert it. And from there, you can configure 
                                    the style of that element. If you need more info please visit <a target="_blank" href="http://getbootstrap.com/css">Base CSS.</a></div></div> 
                        </div>
                    </li>
                    <li class="boxes" id="elmBase">
                        ...
                        <div class="box box-element ui-draggable">
                            ...
                            <div class="view">
                                <p contenteditable="true">Lorem ipsum dolor sit amet, <strong>consectetur adipiscing elit</strong>.
                                    ...
                                    posuere diam ut cursus. <em>Morbi commodo sodales nisi id sodales. Proin
                                        ...
                                        bibendum diam velit et dui.</em> Proin massa magna, vulputate nec bibendum nec, posuere nec lacus. <small>Aliquam mi erat, aliquam vel luctus eu, pharetra quis elit. Nulla euismod ultrices massa, et feugiat ipsum consequat eu. </small></p>
                            </div>
                        </div>
                        <div class="box box-element ui-draggable">
                            <a href="#close" class="remove label label-danger"><i class="glyphicon glyphicon-remove"></i> remove</a>
                        ...
                        <div class="box box-element ui-draggable">
                            ...
                            <div class="view">
                                <img alt="Bootstrap Image Preview" src="include/a_002.jpg">
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="nav nav-list accordion-group">
                    <li class="nav-header"><i class="glyphicon glyphicon-plus"></i> Components <div class="pull-right popover-info"><i class="glyphicon glyphicon-question-sign "></i> 
                            <div class="popover fade right"><div class="arrow"></div> 
                                ...
                                <div class="popover-content">Drag &amp; Drop the elements inside the 
                                    columns where you want to insert it. And from there, you can configure 
                                    the style of that component. If you need more info please visit  <a target="_blank" href="http://getbootstrap.com/components">Components.</a></div></div> 
                        </div>
                    </li>
                    <li class="boxes" id="elmComponents">
                        ...
                        <div class="box box-element ui-draggable">
                            ...
                            <div class="view">
                                ...
                                <p contenteditable="true">Donec id elit non mi porta gravida at eget 
                        ...
                        <div class="box box-element ui-draggable">
                            ...
                            <div class="view">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            <img alt="Bootstrap Thumbnail First" src="include/people-q-c-600-200-1.htm">
                                    ...
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            <img alt="Bootstrap Thumbnail Second" src="include/city-q-c-600-200-1.htm">
                                                <div class="caption" contenteditable="true">
                                                    <h3>Thumbnail label</h3>
                                                    <p>Cras justo odio, dapibus ac facilisis in, egestas
                                                        eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id 
                                    ...
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            <img alt="Bootstrap Thumbnail Third" src="include/sports-q-c-600-200-1.htm">
                                                <div class="caption" contenteditable="true">
                                                    <h3>Thumbnail label</h3>
                                                    <p>Cras justo odio, dapibus ac facilisis in, egestas
                                                        eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id 
                            ...
                            <div class="view">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img alt="Bootstrap Media Preview" src="include/a.jpg" class="media-object">
                                    </a>
                                    <div class="media-body" contenteditable="true">
                                        ...
                                        <div class="media">
                                            <a href="#" class="pull-left">
                                                <img alt="Bootstrap Media Another Preview" src="include/a.jpg" class="media-object">
                                            </a>
                                            <div class="media-body" contenteditable="true">
                                                <h4 class="media-heading">Nested media heading</h4>
                                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus
                    ...
                    <li class="nav-header"><i class="glyphicon glyphicon-plus"></i> JavaScript 
                        <div class="pull-right popover-info"><i class="glyphicon glyphicon-question-sign "></i> 
                            <div class="popover fade right"><div class="arrow"></div> 
                                ...
                                <div class="popover-content">Drag &amp; Drop the elements inside the 
                                    columns where you want to insert it. And from there, you can configure 
                                    the style of that javascript. If you need more info please visit  <a target="_blank" href="http://getbootstrap.com/javascript">JavaScript.</a></div></div> 
                        </div>
                    </li>
                                ...
                                <div class="carousel slide" id="myCarousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img alt="Carousel Bootstrap First" src="include/sports-q-c-1600-500-1.htm">
                                        ...
                                        <div class="item">
                                            <img alt="Carousel Bootstrap Second" src="include/sports-q-c-1600-500-2.htm">
                                                <div class="carousel-caption">
                                        ...
                                        <div class="item">
                                            <img alt="Carousel Bootstrap Third" src="include/sports-q-c-1600-500-3.htm">
                                                <div class="carousel-caption">
            ...
            <div id="bootstrap-template" style="min-height: 630px;" class="demo ui-sortable"></div>
...
<!--        <script type="text/javascript">
    ...
    <script type="text/javascript">if (!NREUMQ.f) {
                    NREUMQ.f = function () {
                        NREUMQ.push(["load", new Date().getTime()]); var e = document.createElement("script");
                ...
                ;
                NREUMQ.push(["nrfj", "bam.nr-data.net", "0748fcde3e", "2111746", "M1ZVZxRUDRJZAE0IXgocdlASXAwPFwFMCF0AbEEASVwNBV0b", 0, 153, new Date().getTime(), "", "", "", "", ""]);</script>



    <script src="include/nr-100.js" type="text/javascript"></script><script src="include/0748fcde3e" type="text/javascript"></script></body></html>