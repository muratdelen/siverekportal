 ...
 */
        ...
        var input = $('<input type="text" class="clearable ' + search_init + sCSSClass
                + '" value="' + txt + '"  placeholder="' + label + '" rel="' + i + '"/>');
...
//        input.bind("keyup.DT search.DT input.DT paste.DT cut.DT", function (e) {
...
//                input.keyup(function () {
        input.on("keyup search input paste cut", function (e) {
...
//                var iCurrentFilterLength = this.value.length;
        ...
        oTable.fnFilter(tval, _fnColumnIndex(index), regex, smart); //Issue 37
                fnOnFiltered();
        }, 100));
...
//                    this.value = asInitVals[index];
        ...
        th.html(_fnRangeLabelPart(0));
                ...
                var from = $('<input type="text" class="number_range_filter form-control search_init" id="' + sFromId + '" rel="' + i + '"/>');
                th.append(from);
                th.append(_fnRangeLabelPart(1));
                var sToId = oTable.attr("id") + '_range_to_' + i;
                var to = $('<input type="text" class="number_range_filter form-control search_init" id="' + sToId + '" rel="' + i + '"/>');
                th.append(to);
        ...
        var aoFragments = sRangeFormat.split(/[}{]/);
                ...
                //th.html(_fnRangeLabelPart(0));
                var sFromId = oTable.attr("id") + '_range_from_' + i;
                var from = $('<input type="text" class="clearable date_range_filter form-control search_init" placeholder="Başlangıç Tarihi" id="' + sFromId + '" rel="' + i + '"/>');
                from.datepicker();
                //th.append(from);
                //th.append(_fnRangeLabelPart(1));
                var sToId = oTable.attr("id") + '_range_to_' + i;
                var to = $('<input type="text" class="clearable date_range_filter form-control search_init" placeholder="Bitiş Tarihi" id="' + sToId + '" rel="' + i + '"/>');
                //th.append(to);
                //th.append(_fnRangeLabelPart(2));
        ...
        from.add(to).focus(function () {
        if ($(this).hasClass("search_init")) {
        $(this).removeClass("search_init");
        }
        });
//             input.bind("keyup search input paste cut", function (e) {

                from.add(to).bind("blur", function (e) {
//            $(this).addClass("search_init");
...
//            sRangeFormat: "From {from} to {to}",
                ...
                // /////
                        ...
                        $(document).on('input change focus', '.clearable', function(){
