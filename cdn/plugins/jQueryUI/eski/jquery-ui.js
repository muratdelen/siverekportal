/**
 * Bu Uygulama Bilgisayar Mühendisi Murat DELEN Tarafından Yapılmıştır.
 * http://muratdelen.com/
 */
(function( $, undefined ) {
...
function Datepicker() {
	...
	this.regional["tr"] = { // Default regional settings
		...
		dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], // For formatting
		dayNamesMin: ["Pz","Pts","Sa","Çar","Per","Cu","Cts"], // Column headings for days starting at Sunday
		weekHeader: "H", // Column header for week of the year
