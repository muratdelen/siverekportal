...
$options1 = array(
    ...
    'order' => array(12, 'desc'),
    'tableFooters' => array('Kullanıcı Adı', 'Adı', 'Soyadı', 'Grubu', 'İşlem Yetkisi', 'Başlık', 'Açıklama', 'Sayfa Url', 'Tablodaki İşlem', 'Table Adı', 'Table Id', 'Yeni Veriler', 'Eski Veriler', 'ip', 'Zaman', 'Aktif mi?'),
    'filters' => array('text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text', 'text'),
    'buttons' => array('excel'),
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Sayfa İşlem Kayıtları</a></li>
        </ol>
    </section>
