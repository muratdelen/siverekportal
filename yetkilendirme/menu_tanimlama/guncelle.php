...
<div class="col-md-12 box box-primary" id="yeni_kayit_ekrani_div">
    <form class="form-horizontal" method="post"  id="form_menu_guncelle" action="postPage.php">
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-sm-8">
                <input type="text" id="menu_left_icon" name = "menu_left_icon" value="<?= $menu_bilgisi->sol_icon ?>" placeholder=" Giriniz" class="form-control">
            </div>  
        </div> 
        <div class="form-group form-group-sm">
            ...
            <div class="col-sm-8">
                <input type="text" id="menu_right_icon" name = "menu_right_icon" value="<?= $menu_bilgisi->sag_icon ?>" placeholder=" Giriniz" class="form-control">
            </div>  
        </div>
        <div class="form-group form-group-sm">
